 ...
 * mlog_aresame()
 *
 * Check to see if the two logs passed in are the same.
 */
 ...
 * mlog_getprops_cmn()
 *
 * Fill in basic mlog properties from layout.
 */
static void
mlog_getprops_cmn(
 ...
 * mlog_rw_internal:
 *
 * Called by both user and kernel mlogs for IO requests. This calls into ecio
 * layer.
